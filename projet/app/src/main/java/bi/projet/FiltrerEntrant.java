...
public class FiltrerEntrant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtrer_entrant);
        ...
        cursor = con.selectionnerFiltrerEntrant();
...
//pour ajouter les appels sortants à la base de données
        call.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(FiltrerEntrant.this, "Vérifiez vos permissions", Toast.LENGTH_LONG).show();
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(FiltrerEntrant.this,Menu.class);
