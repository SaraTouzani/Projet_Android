...
public class FiltrerSortant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtrer_sortant);
        ...
        cursor = con.selectionnerFiltrerSortant();
...
//pour ajouter les appels sortants à la base de données
        call.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(FiltrerSortant.this, "Vérifiez vos permissions", Toast.LENGTH_LONG).show();
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(FiltrerSortant.this,Menu.class);
