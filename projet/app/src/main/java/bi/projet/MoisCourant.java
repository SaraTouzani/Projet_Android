...
public class MoisCourant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mois_courant);
        ...
        cursor = con.selectionnerMoisCourant();
...
//pour ajouter les appels sortants à la base de données
        call.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(MoisCourant.this, "Vérifiez vos permissions", Toast.LENGTH_LONG).show();
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(MoisCourant.this,Menu.class);
