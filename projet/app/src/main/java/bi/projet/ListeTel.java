...
public class ListeTel extends AppCompatActivity {

    EditText number;
    Button call, delete,sms;
    ListView lvAppels;
    Button more;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = con.selectionner();
        appels=con.getAppels();
...
//pour ajouter les appels sortants à la base de données
        call.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(ListeTel.this, "Vérifiez vos permissions", Toast.LENGTH_LONG).show();
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(ListeTel.this,Menu.class);
        ...
        sms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(Intent.ACTION_VIEW, Uri.parse("sms:" + number.getText().toString()));
